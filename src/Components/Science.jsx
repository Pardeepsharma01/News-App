...
const General = () => {
    ...
    const getnewsapi = async () => {
      let url = `https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=f880a99d11114dfdac7e0ff4c7bf7940&pageSize=1`;
    ...
    {loader ? (
      ...
      <div>
        {headline?.map((element) => {
          return (
            <div>
            <a href={element.url} className="text-decoration-none text-left">
