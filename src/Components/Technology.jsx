...
const Technology = () => {
  ...
  const getnewsapi = async () => {
    let url = `https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=f880a99d11114dfdac7e0ff4c7bf7940&pageSize=1`;
              ...
              <div>
                <a href={element.url} className="text-decoration-none">
                  <Card className="custom-card">
                    <Card.Img variant="top" src={element.urlToImage || defaultImageUrl } style={{ width: '100%', height: '200px' }}/>
                    <Card.Body>
                      <Card.Text className="fw-bold text-decoration-none fs-2 my-underline">{element.title.slice(0,40)}....</Card.Text>
                    </Card.Body>
                    <div className="bottom-name">
              <p className="">Technology News</p>
              </div>
                  </Card>
                </a>
              </div>
